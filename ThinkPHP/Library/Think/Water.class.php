...
/* PHP图片加文字水印类库
  ...
  QQ:416148489 素材火www.sucaihuo.com
...
//            $this->image = $img;
            $arr_in_name = explode(".", $img);
            $imgCopy = $arr_in_name[0] . "_water." . $arr_in_name[1];
            copy($img, $imgCopy);
            $this->image = $imgCopy; //临时处理的图片，很重要
            $this->img_text = $txt;
    ...
    //显示图片
    function img_show() {
        echo '<img src="' . $this->image . '" border="0" alt="' . $this->img_text . '" />';
    }
